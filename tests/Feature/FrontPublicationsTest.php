...
class FrontPublicationsTest extends FeatureTestCase
{
    ...
    {
        $data_publications = [
            ['category_id' => 1, 'title' => 'Publication 1', 'state' => 1, 'preview' => '', 'direction' => 'right', 'show_slider' => 1,
                'author' => 'John Smith', 'show_author_category' => 1, 'show_author_publication' => 1,
                'description' => '<p>Test</p>',
                'show_description_category' => 1, 'show_description_publication' => 1],
            ['category_id' => 1, 'title' => 'Publication 2', 'state' => 1, 'preview' => '', 'direction' => 'right', 'show_slider' => 1,
                'author' => 'John Smith', 'show_author_category' => 1, 'show_author_publication' => 1,
                'description' => '<p>Test</p>',
                'show_description_category' => 1, 'show_description_publication' => 1],
            ['category_id' => 2, 'title' => 'Publication 3', 'state' => 0, 'preview' => '', 'direction' => 'left', 'show_slider' => 0,
                'author' => 'John Smith', 'show_author_category' => 0, 'show_author_publication' => 0,
                'description' => '<p>Test</p>',
                'show_description_category' => 0, 'show_description_publication' => 0],
        ];

        foreach ($data_publications as $data_publication) {
            Publication::forceCreate($data_publication);
        }
    }
