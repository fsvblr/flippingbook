@props(['route'=>'publications.index'])

<a href="{{ route('flippingbook.site.categories.index') }}"
   class="mb-5 {{ $route === 'publications.index' ? ' min-[400px]:ml-5 rtl:min-[400px]:mr-3' : ' min-[550px]:ml-5 rtl:min-[550px]:mr-3' }}">
    <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
        ...
        <span class="relative inline-flex items-center justify-center px-4 py-2 -ml-px text-sm font-medium text-gray-500 bg-white
            ...
            {{ __('flippingbook::flippingbook.FLIPPINGBOOK_SITE_MENU_ITEM_CATEGORIES') }}
        </span>
    </span>
</a>
